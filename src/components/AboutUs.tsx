      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16" ref={ref}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <motion.div 
            ...
            className="max-w-xl"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-light/50 border border-primary-light mb-6">
              <span className="w-2 h-2 rounded-full bg-primary-dark"></span>
              <span className="text-xs font-semibold text-primary-dark tracking-wider uppercase">Sobre a {config.company.name}</span>
            </div>
