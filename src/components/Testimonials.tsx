      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {config.testimonials.reviews.slice(0, 3).map((review, i) => (
            ...
            >
              {/* Hover glow */}
              <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-br from-blue-500/6 via-transparent to-blue-400/4 pointer-events-none" />
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                <Quote className="w-7 h-7 text-blue-400/30 flex-shrink-0" strokeWidth={1.5} />
              </div>
